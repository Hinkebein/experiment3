...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/course/updateCourse" method="post" enctype="multipart/form-data"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="hours" name="hours" value="${course.getHours()}" placeholder="课程时长">
        </div>
        <div class="form-group">
            <label for="school"> 开设学院：</label>
            <input type="text" class="form-control" id="school" name="school" value="${course.getSchool()}" placeholder="开设学院">
        </div>
        <div class="form-group">
