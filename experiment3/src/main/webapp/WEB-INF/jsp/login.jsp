    ...
    <div class="py-container">
        ...
        <div class="loginform">
            ...
            <div class="tab-content tab-wraped">
                <span style="color: #1b97b2">${msg}</span>
                <div id="profile" class="tab-pane  active">
                    <form id="loginform" class="sui-form"
                          action="${pageContext.request.contextPath}/course/login" method="post">
                        <div class="input-prepend"><span class="add-on loginname">邮箱</span>
                            <input type="text" placeholder="邮箱" class="span2 input-xfat" name="email">
                        </div>
                        <div class="input-prepend"><span class="add-on loginpwd">密码</span>
                            <input type="password" placeholder="密码" class="span2 input-xfat" name="password">
                        </div>
                        <div class="logined">
                            <a class="sui-btn btn-block btn-xlarge btn-danger"
                               href='${pageContext.request.contextPath}/course/allCourse'
                               target="_self">登&nbsp;&nbsp;录</a>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    ...
    if (window != _topWin)
        _topWin.document.location.href = '${pageContext.request.contextPath}/WEB-INF/jsp/login.jsp';
</script>
